...
//!
//! Parses qihangai:// URLs into DeepLinkImportRequest structures.
...
/// Parse a qihangai:// URL into a DeepLinkImportRequest
///
/// Expected format:
/// qihangai://v1/import?resource={type}&...
pub fn parse_deeplink_url(url_str: &str) -> Result<DeepLinkImportRequest, AppError> {
    ...
    if scheme != "qihangai" {
        return Err(AppError::InvalidInput(format!(
            "Invalid scheme: expected 'qihangai', got '{scheme}'"
        )));
    }

//! Deep link import functionality for Qihang AI Coding Assistant
//!
//! This module implements the qihangai:// protocol for importing configurations
...
///
/// Represents a parsed qihangai:// URL ready for processing.

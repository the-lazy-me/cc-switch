...
/// 将 `/path/to/Qihang AI Coding Assistant.app/Contents/MacOS/Qihang AI Coding Assistant` 转换为 `/path/to/Qihang AI Coding Assistant.app`
#[cfg(target_os = "macos")]
...
mod tests {
    ...
    fn test_get_macos_app_bundle_path_valid() {
        let exe_path = std::path::Path::new("/Applications/Qihang AI Coding Assistant.app/Contents/MacOS/Qihang AI Coding Assistant");
        let result = get_macos_app_bundle_path(exe_path);
        assert_eq!(
            result,
            Some(std::path::PathBuf::from("/Applications/Qihang AI Coding Assistant.app"))
        );
    }
    ...
    fn test_get_macos_app_bundle_path_with_spaces() {
        let exe_path =
            std::path::Path::new("/Users/test/My Apps/Qihang AI Coding Assistant.app/Contents/MacOS/Qihang AI Coding Assistant");
        let result = get_macos_app_bundle_path(exe_path);
        assert_eq!(
            result,
            Some(std::path::PathBuf::from(
                "/Users/test/My Apps/Qihang AI Coding Assistant.app"
            ))
        );
    }
    ...
    fn test_get_macos_app_bundle_path_not_in_bundle() {
        let exe_path = std::path::Path::new("/usr/local/bin/qihang-ai-coding-assistant");
        let result = get_macos_app_bundle_path(exe_path);
    ...
    fn test_get_macos_app_bundle_path_dev_build() {
        ...
        let exe_path =
            std::path::Path::new("/Users/dev/project/target/debug/qihang-ai-coding-assistant");
        let result = get_macos_app_bundle_path(exe_path);
        assert_eq!(result, None);
    }
}
